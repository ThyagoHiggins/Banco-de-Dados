...
valorLIMITE float(7,2),
primary key (idgrupo)
);

drop table grupo_doador;
...
select*from grupo_doador;
insert into visitante values
(default,'Jose Silva','25','11985741236','jose@ig.com.br','Atibaia', 'SP','1','2','20'),
(default,'Atila Abreu','30','11985479632','atila@uol.com.br','São Paulo','SP','3','4','70'),
(default,'Renata Fan Oliveira','46','11963852174','renata@terra.com','São Paulo','SP','2','5','50'),
(default,'Gabriel Camargo','25','11985741236','gabriel@bol.com.br','Mairiporã','SP','2','1','10'),
(default,'Amanda Genise','31','11985741236','amanda@gmail.com', 'Vinhedo','SP','3','4','70'),
(default,'Haroldo Silva Caetano','52','11985741236','caetano@bol.com','Bragança Paulista','SP','2','1','10'),
(default,'Maria Heleha Oliveira','81','11985741236','mho@gamil.com','Atibaia','SP','3','2','20'),
(default,'Valeria Dominique','29','11985741232','jaja@uol.com.br','Marzagão','GO','3','6','300'),
(default,'Leoncio Leonel','45','11985456396','lele@uol.com.br', 'Tuiti','SP','3','5','100'),
(default,'Ravena Silva','25','11985456325','rava@ig.com.br', 'Bragança Paulista','SP','3','3','50'),
(default,'Kiara Oliveira','26','11978965241','kiara@gmail.com','Paris','FR','3','2','20'),
(default,'Thyago A','31','11985741236','thyago@ig.com.br','São Paulo','SP','3','6','300'),
(default,'Joao Carlos','25','11985259632','joao@ig.com.br', 'Tatui','SP','2','2','30'); 
...
alter table acervo
modify column datacriacao varchar(4);
...
from visitante v  inner join grupo_doador g
...
#------------------------------------------------------------------------------------------------------
# Query 9 - Valor Total de Doação recebida por Acervo
...
#------------------------------------------------------------------------------------------------------
# Query 10
#Seleção do Visitante que doou o maior valor
